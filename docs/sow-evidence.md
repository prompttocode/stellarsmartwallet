...
| ---------------- | ---------------------------------------- | ------ | --------------------------------- |
| Backend health   | https://api.getstellar.shop/api/health   | PASS   | Cloudflare Worker public endpoint |
| Backend networks | https://api.getstellar.shop/api/networks | TODO   | Chup screenshot JSON khi nop      |
